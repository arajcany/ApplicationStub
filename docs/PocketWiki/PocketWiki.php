<?php
/**
 * Filesystem based Wiki that uses Markdown as the storage engine.
 * Useful for creating smaller help pages and or knowledge bases.
 */
class PocketWiki
{
    ...
    public function __construct($config)
    {
        ...
        if (!$this->config['app_url']) {
            $this->config['app_url'] = '//' . $_SERVER['HTTP_HOST'] . str_replace('index.php', '',
                    $_SERVER['SCRIPT_NAME']);
        }
